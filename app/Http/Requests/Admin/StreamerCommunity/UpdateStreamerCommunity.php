...
class UpdateStreamerCommunity extends FormRequest
{
    /**
    ...
    {
        return Gate::allows('admin.streamer-community.edit', $this->streamerCommunity);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'streamer_name' => ['sometimes', 'string'],
            'description' => ['sometimes', 'string'],
            'twitch_url' => ['sometimes', 'string'],
