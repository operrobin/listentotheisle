...
class FillPermissionsForStreamerCommunity extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStreamerCommunity constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.streamer-community',
            'admin.streamer-community.index',
            'admin.streamer-community.create',
            'admin.streamer-community.show',
            'admin.streamer-community.edit',
            'admin.streamer-community.delete',
            'admin.streamer-community.bulk-delete',
        ]);
