...
class FillPermissionsForSongCollection extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSongCollection constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.song-collection',
            'admin.song-collection.index',
            'admin.song-collection.create',
            'admin.song-collection.show',
            'admin.song-collection.edit',
            'admin.song-collection.delete',
            'admin.song-collection.bulk-delete',
        ]);
