...
class FillPermissionsForYoutubeCollection extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForYoutubeCollection constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.youtube-collection',
            'admin.youtube-collection.index',
            'admin.youtube-collection.create',
            'admin.youtube-collection.show',
            'admin.youtube-collection.edit',
            'admin.youtube-collection.delete',
            'admin.youtube-collection.bulk-delete',
        ]);
