...
class FillPermissionsForWordStaticPage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForWordStaticPage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.word-static-page',
            'admin.word-static-page.index',
            'admin.word-static-page.create',
            'admin.word-static-page.show',
            'admin.word-static-page.edit',
            'admin.word-static-page.delete',
            'admin.word-static-page.bulk-delete',
        ]);
