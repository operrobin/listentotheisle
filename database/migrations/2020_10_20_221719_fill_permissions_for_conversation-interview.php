...
class FillPermissionsForConversationInterview extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForConversationInterview constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.conversation-interview',
            'admin.conversation-interview.index',
            'admin.conversation-interview.create',
            'admin.conversation-interview.show',
            'admin.conversation-interview.edit',
            'admin.conversation-interview.delete',
            'admin.conversation-interview.bulk-delete',
        ]);
